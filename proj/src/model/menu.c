...
void create_menu_sprites(){
    ...
    menu_title = create_sprite_xpm(menu_title_pixmaps,1, 280,150);
    menu_play = create_sprite_xpm(menu_play_pixmaps,2, 289,300);
    instructions = create_sprite_xpm(instructions_pixmaps,2, 110,400);
}
